...
now_playing:subscribe("media_change", function(env)
	if whitelist[env.INFO.app] then
		...
		now_playing:set({
			...
			drawing = (env.INFO.title ~= "" or env.INFO.artist ~= ""),
